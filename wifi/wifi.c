...
#endif
#define WIFI_TEST_INTERFACE		"sta" // setprop wifi.interface wlan0
...
static const char SUPP_PROP_NAME[]      = "init.svc.rtw_suppl";
static const char P2P_SUPPLICANT_NAME[] = "rtw_suppl_con"; /* p2p concurrent */
static const char P2P_PROP_NAME[]       = "init.svc.rtw_suppl_con";

//static const char SUPPLICANT_NAME[]     = "wpa_supplicant";
//static const char SUPP_PROP_NAME[]      = "init.svc.wpa_supplicant";
//static const char P2P_SUPPLICANT_NAME[] = "rtw_suppl_con";//"p2p_supplicant";
